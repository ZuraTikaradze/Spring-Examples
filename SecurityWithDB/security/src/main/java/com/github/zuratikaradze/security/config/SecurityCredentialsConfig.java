...
public class SecurityCredentialsConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/hi/**").hasRole("USER")// ამ url -ზე მარტო USER როლის პატროს შეუძლია წვდომა
                .antMatchers("/api/hi2/**").hasRole("ADMIN")// ამ url -ზე მარტო ADMIN როლის პატროს შეუძლია წვდომა
